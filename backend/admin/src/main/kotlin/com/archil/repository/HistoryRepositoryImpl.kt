...
class HistoryRepositoryImpl : HistoryRepositoryCustom {
    private val table = "histories"
    @PersistenceContext
    private lateinit var em: EntityManager

    override fun searchHistories(query: TableQuery): TableResult {
        ...
        if (query.dateRange != null) {
            between += " WHERE u.createdate BETWEEN '"
