...
class PointerData extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      gridTD: Array(7).fill(Array(11).fill('')), gridSD: Array(7).fill(Array(11).fill('')), gridType: Array(10).fill(''), gridData: Array(5).fill(Array(10).fill('')),
  ...
  update_pad = async () => {
    ...
    if (this.state.action === "C") {
      message = update_pointer_record(this.props.somos.id, this.props.somos.ro, "C", fix_num(this.state.num), this.state.sfed, this.state.abn,
      ...
      message = create_pointer_record(this.props.somos.id, this.props.somos.ro, this.state.action, fix_num(this.state.num), this.state.sfed, this.state.abn, this.state.dau, this.state.dat, this.state.ddt, this.state.hold,
      ...
      message = disconnect_pointer(this.props.somos.id, this.props.somos.ro, this.state.action, fix_num(this.state.num), this.state.sfed, this.state.referral, this.state.end);
    } else if (this.state.action === "R") {
      message = resend_pointer(this.props.somos.id, this.props.somos.ro, this.state.action, fix_num(this.state.num), this.state.sfed);
    }
    console.log(message);
  ...
  copy_pointer = () => {
    ...
    !this.state.copy_cr && this.setState({lns: '', iec: '', iac: '', network: '' });
    !this.state.copy_lad &&
  ...
  delete_pointer = async () => {
    ...
    let message = deletePad(this.props.somos.id, this.props.somos.ro, date, fix_num(this.state.copy_num), this.state.template);
    console.log(message);
    let res = await this.props.callApi2(RestApi.sendRequestNew, {'mod': "CRC", 'message': message, 'timeout': timeout});
    if (res.ok && res.data && res.data.message) {
      console.log(res.data.message);
  ...
  convertPadToCad = async () => {
    ...
    let message = padToCad(this.props.somos.id, this.props.somos.ro, date, fix_num(this.state.num), this.state.sfed);
    console.log(message);
    let res = await this.props.callApi2(RestApi.sendRequestNew, {'mod': "CRC", 'message': message, 'timeout': timeout});
    if (res.ok && res.data && res.data.message) {
      console.log(res.data.message);
  ...
  transfer = async () => {
    ...
    let message = transferPad(this.props.somos.id, this.props.somos.ro, date, fix_num(this.state.copy_num), this.state.template, this.state.ed_origin, this.state.et_origin);
    console.log(message);
    let res = await this.props.callApi2(RestApi.sendRequestNew, {'mod': "CRC", 'message': message, 'timeout': timeout});
    if (res.ok && res.data && res.data.message) {
        ...
        <Row>
          <Col xs="12">
            <Card>
              ...
              <div className="mb-1 ml-4 mr-4 mt-1 mb-2 border" style={{borderRadius: 5, borderColor: '#c8ced3',backgroundColor: '#f0f3f5'}}>
                ...
                <div className="mt-3 mb-1 ml-4 mr-4 border" style={{borderRadius: 5, borderColor: '#c8ced3', backgroundColor: '#f0f3f5'}}>
                  <Row className="mt-2 ml-4 mr-4">
                    <Col xs="12" md="6" className="row">
                      ...
                      <Input className="col-4 form-control-sm" type="text" name="template" id="template" onChange={(ev) => this.handle(ev)} value={this.state.num} disabled={this.state.disable} />
                    </Col>
                    <Col xs="12" md="6" className="row">
                      <Label className="col-5 font-weight-bold">Eff.Date/Time/Status:</Label>
                ...
                <Card>
                  <div className="mt-3 mb-1 ml-4 mr-4 border" style={{borderRadius: 5, borderColor: '#c8ced3', backgroundColor: '#f0f3f5'}}>
                    <Row className="mt-2 ml-4 mr-4">
                      <Col xs="12" md="6" className="row">
                        <p className="col-5 font-weight-bold">Dial#/Template Name *:</p>
                        <Input className="col-4 form-control-sm" type="text" name="num" id="num" onChange={(ev) => this.handle(ev)} value={this.state.num} disabled={this.state.disable}/>
                      </Col>
                      <Col xs="12" md="6" className="row">
                        <Label className="col-5 font-weight-bold">Eff.Date/Time/Status:</Label>
                        <Input className="col-4 form-control-sm" type="text" name="sfed" id="sfed" onChange={(ev) => this.handle(ev)} value={this.state.sfed} disabled={this.state.disable}/>
                        ...
                        </tr>
                        {
                          this.state.gridData.map((datas, k) => {
                            return (
                              <tr>
                                {datas.map((data, g) => {
                                  return (<td><Input type="text" className="form-control-sm" name={k + "_" + g} value={data} onChange={(ev) => this.handleValue(ev)}
