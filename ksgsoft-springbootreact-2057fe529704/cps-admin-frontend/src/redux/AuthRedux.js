...
const {logout,loginSuccess, loginFailed, refreshToken, refreshTokenSuccess, refreshRolesSuccess, profileUpdated} =
  createActions({}, Actions.LOGOUT, Actions.LOGIN_SUCCESS, Actions.LOGIN_FAILED, Actions.REFRESH_TOKEN, Actions.REFRESH_TOKEN_SUCCESS, Actions.REFRESH_ROLES_SUCCESS, Actions.PROFILE_UPDATED);
